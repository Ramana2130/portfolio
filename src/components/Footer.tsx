...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-violet-100 dark:bg-black text-black dark:text-white">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full bg-green-400 dark:bg-green-600">
				...
				<span className="self-center text-2xl font-semibold">RAMANA S</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center text-gray-400 dark:text-gray-600">© 2024 Company Co. All rights reserved.</div>
</footer>
  )
}
